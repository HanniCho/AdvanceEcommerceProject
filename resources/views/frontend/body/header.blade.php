          ...
          <ul class="list-unstyled list-inline">
            ...
            <li class="dropdown dropdown-small"> <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"><span class="value">
              ...
              <ul class="dropdown-menu">
                @if(session()->get('language') == 'myanmar')
                  @if(session()->get('currency') == 'kyat')
                  <li><a href="{{route('usd.currency')}}">အမေရိကန်ဒေါ်လာ</a></li>
                  @else
                  <li><a href="{{route('kyat.currency')}}">မြန်မာကျပ်</a></li>
                  @endif
                @else
                  @if(session()->get('currency') == 'kyat')
                  <li><a href="{{route('usd.currency')}}">USD</a></li>
                  @else
                  <li><a href="{{route('kyat.currency')}}">Myanmar Kyat</a></li>
                  @endif
                @endif
              </ul>
            </li>
            <li class="dropdown dropdown-small"> 
              ...
              <ul class="dropdown-menu">
                ...
                @else
                <li><a href="{{route('myanmar.language')}}">မြန်မာ</a></li>
                @endif
              </ul>
            </li>
          </ul>
          ...
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            <div class="nav-outer">
              <ul class="nav navbar-nav">
                <li class="active dropdown yamm-fw"> <a href="{{url('/')}}" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown"> @if(session()->get('language') == 'myanmar') ပင်မစာမျက်နှာ @else Home @endif </a> </li>
                <!-- Gete category table data -->
                @php
                $categories = App\Models\Category::orderBy('category_name_en','ASC')->get();
                @endphp
                @foreach($categories as $category)
                <li class="dropdown yamm mega-menu"> <a href="home.html" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">@if(session()->get('language') == 'myanmar') {{$category->category_name_mm}} @else {{$category->category_name_en}} @endif </a>
