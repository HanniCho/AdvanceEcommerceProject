  ...
  <div class="container">
    <div class="breadcrumb-inner">
      <ul class="list-inline list-unstyled">
        ...
        <li>{{$sub_category->category->category_name_en}}</li>
        <li class='active'>{{$sub_category->subcategory_name_en}}</li>
      </ul>
    </div>
    <!-- /.breadcrumb-inner --> 
  </div>
      ...
      <div class='col-md-3 sidebar'> 
        ...
        <div class="sidebar-module-container">
          <div class="sidebar-filter"> 
            <!-- ============================================== SHOP BY CATEGORY ============================================== -->
            @include('frontend.include.shop_by') 
                      ...
                      <div class="row product-list-row">
                        ...
                        <div class="col col-sm-8 col-lg-8">
                          <div class="product-info">
                            ...
                            @endif
                            <!-- /.product-price -->
                            <div class="description m-t-10">@if(session()->get('language') == 'myanmar') {{$product->short_descp_mm}} @else {{$product->short_descp_en}} @endif</div>
                            <div class="cart clearfix animate-effect">
                              <div class="action">
                                <ul class="list-unstyled">
                                  <li class="add-cart-button btn-group">
